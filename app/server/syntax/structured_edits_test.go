			...
			original: `
{
  "name": "vscode-llmcode",
  "displayName": "Llmcode",
  "description": "VSCode extension for Llmcode integration",
  "version": "0.1.0",
  "engines": {
    "vscode": "^1.80.0"
  },
  ...
  "contributes": {
    ...
    "keybindings": [{
      ...
      "key": "@",
      "when": "editorTextFocus && editorLangId == llmcode"
    }]
  },
  "scripts": {
			...
			proposed: `
{
  ...
  "contributes": {
    "languages": [{
      ...
      "icon": {
          "light": "./icons/llmcode-light.png",
          "dark": "./icons/llmcode-dark.png"
      }
    }],
    "grammars": [{
      "language": "llmcode",
      "scopeName": "text.llmcode",
      "path": "./syntaxes/llmcode.tmLanguage.json",
      "embeddedLanguages": {
