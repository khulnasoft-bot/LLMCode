...
The full resulting file should be output within a <LlmcodeWholeFile> element, like this:
...
Do NOT include line numbers in the <LlmcodeWholeFile> element. Do NOT include reference comments in the <LlmcodeWholeFile> element. Output the ENTIRE file, no matter how long it is, with NO EXCEPTIONS. Include the resulting file *only* with no other text. Do NOT wrap the file output in triple backticks or any other formatting, except for the <LlmcodeWholeFile> element tags.

Do NOT include any additional text after the <LlmcodeWholeFile> element. The output must end after </LlmcodeWholeFile>. DO NOT use the string <LlmcodeWholeFile> anywhere else in the output. ONLY use it to start the <LlmcodeWholeFile> element.
