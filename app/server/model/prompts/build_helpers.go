...
You must analyze the *original file* and the *proposed updates* and output a <LlmcodeComments> element that lists *EVERY* comment in the *proposed updates*, including the line number of each comment prefixed by 'g4c-new-'. Below each comment, evaluate whether it is a reference comment.
...
If there are no comments in the *proposed updates*, output an empty <LlmcodeComments> element.
