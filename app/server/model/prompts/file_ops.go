...
You ABSOLUTELY MUST end every file operation section with a <EndLlmcodeFileOps/> tag.
...
- You MUST end the '### Move Files' section with a <EndLlmcodeFileOps/> tag
...
- You MUST end the '### Remove Files' section with a <EndLlmcodeFileOps/> tag
...
- Each path must be on its own line
- You MUST end the '### Reset Changes' section with a <EndLlmcodeFileOps/> tag
...
3. Format Rules:
  ...
  - You MUST end each file operation section with a <EndLlmcodeFileOps/> tag
