...
func GetTerminalWidth() int {
	...
	if os.Getenv("LLMCODE_COLUMNS") != "" {
		w, err := strconv.Atoi(os.Getenv("LLMCODE_COLUMNS"))
		if err == nil {
			envReplCols = w
			return w
		}
...
func GetStreamForegroundColor() termenv.Color {
	...
	if os.Getenv("LLMCODE_STREAM_FOREGROUND_COLOR") != "" {
		envStreamForegroundColor = termenv.ANSI256.Color(os.Getenv("LLMCODE_STREAM_FOREGROUND_COLOR"))
		return envStreamForegroundColor
	}
