...
func ConvertTrial() {
	openAuthenticatedURL("Opening Llmcode Cloud upgrade flow in your browser.", "/settings/billing?upgrade=1&cliUpgrade=1")
	...
	term.StopSpinner()
	term.OutputErrorAndExit("Timed out waiting for upgrade. Please try again. Email support@llmcode.khulnasoft.com if the problem persists.")
}
...
func startTrial() {
	...
	openUnauthenticatedCloudURL(
		"Opening Llmcode Cloud trial flow in your browser.",
	...
	term.StopSpinner()
	term.OutputErrorAndExit("Timed out waiting for trial to start. Please try again. Email support@llmcode.khulnasoft.com if the problem persists.")
}
