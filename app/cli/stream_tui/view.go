...
func (m streamUIModel) renderMissingFilePrompt() string {
	...
	desc := "This file exists in your project, but isn't loaded into context. Unless you load it into context or skip generating it, Llmcode will fully overwrite the existing file rather than applying updates."
